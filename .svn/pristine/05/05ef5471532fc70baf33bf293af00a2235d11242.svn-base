...
public class ComRight  implements Serializable {
	...
	private Integer posRefreshNum;//购买点数-【职位刷新】
	private Integer posRefreshUseNum;//使用点数-【职位刷新】
	...
	public Integer getPosRefreshUseNum() {
		return posRefreshUseNum;
	}

	public void setPosRefreshUseNum(Integer posRefreshUseNum) {
		this.posRefreshUseNum = posRefreshUseNum;
	}
