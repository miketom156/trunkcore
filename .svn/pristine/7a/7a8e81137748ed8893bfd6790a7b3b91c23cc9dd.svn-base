...
public class PerUserSrvTest extends TestBase {
    ...
    public void testCheckPerEmailExist() {
        //邮件已被用
        Assert.assertTrue("emailUse", perUserSrv.checkPerEmailExist("961580081@qq.com"));
        //邮件未使用
    ...
    public void testCheckPerMobileExist() {
        //手机号已被用
        Assert.assertTrue("mobileUse", perUserSrv.checkPerMobileExist("18028921558"));
        //手机号未使用
    ...
    public void testLogin() {
        Integer pid = 4231485;
        String userName = "常洪超", ip = "192.168.1.1";
