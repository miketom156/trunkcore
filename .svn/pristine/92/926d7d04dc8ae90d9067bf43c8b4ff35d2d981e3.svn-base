...
public enum BizRetCode {
     ...
     */
    RESUME_INCOMPLETE("resume_incomplete", "您的简历不完整，请先补充必填信息再执行操作${msg}"),
    /**
    ...
    PER_SEARCHER_UPDATE_ERROR("per_searcher_update_error","搜索器更新出错，请刷新后重试"),
    
    //个人设置
   ERROR_ENTERED_PASSWORD_DIFFER("error_enter_password_differ","确认新密码和新密码不一致！"),
   ERROR_CURRENT_PASSWORD("error_current_password","当前密码输入错误！"),
   SUCCESS_MODIFY_PASSOWRD("success_modify_passowrd","新密码修改成功！");
