...
public class PerUserEaoTest extends TestBase {
    ...
    public void testFind(){
        //测试点：校验账号密码成功
        Assert.assertEquals("cyc_2010",DEFAULT_PID,perUserEao.find("cyc_2010", "123456").getId());
        //测试点：密码错误
    ...
    public void testFindEmailUsage(){
        //测试点：email没有被别人占用
        Assert.assertTrue("emailNoOtherUse",perUserEao.findEmailUsage("59281665@qq.com",DEFAULT_PID)==0);
        //测试点：email已被用
        Assert.assertTrue("emailUse",perUserEao.findEmailUsage("59281665@qq.com",0)>0);
        //测试点：email未使用
    ...
    public void testFindMobileUsage(){
        //测试点：手机号没有被别人占用
        Assert.assertTrue("mobileNoOtherUse",perUserEao.findMobileUsage("13790373210",DEFAULT_PID)==0);
        //测试点：手机号已被用
        Assert.assertTrue("mobileUse",perUserEao.findMobileUsage("13790373210",0)>0);
        //测试点：手机号未使用
    ...
    public void testFindByAccount(){
        //测试点：根据账号找实体
        Assert.assertEquals("account",DEFAULT_PID,perUserEao.findByAccount("cyc_2010").get(0).getId());
        //测试点：无此账号
