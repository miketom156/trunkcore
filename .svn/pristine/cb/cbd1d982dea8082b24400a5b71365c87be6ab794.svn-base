...
public class ComUser implements Serializable {
    ...
    private Integer pointOwn;//可用最大点数-【简历下载】【-1】为不限
    private Integer pointUsed;//已用点数-【简历下载】
    private Integer smsOwn;//可用最大点数-【发送短信】【-1】为不限
    private Integer smsUsed;//已用点数-【发送短信】
    private Integer posOwn;//可用最大点数-【职位刷新】【-1】为不限
    private Integer posUsed;//已用点数-【职位刷新】
    ...
    public Integer getSmsOwn() {
        return smsOwn;
    }

    public void setSmsOwn(Integer smsOwn) {
        this.smsOwn = smsOwn;
    }
    ...
    public Integer getPosOwn() {
        return posOwn;
    }

    public void setPosOwn(Integer posOwn) {
        this.posOwn = posOwn;
    }

    public Integer getPosUsed() {
        return posUsed;
    }

    public void setPosUsed(Integer posUsed) {
