 ...
 */
@MappedSuperclass
public class ComResumeCenter  implements Serializable {
    ...
    private String mark;//不符合,符合,待定,已面试,待邀请,已邀请,自定义标签  CommonEnum.ComReceiveMark
    private String remark;//标注内容
    private Integer sysRecommend;//1:后台推荐的简历  --只是用来是否显示为推荐，不做统计使用
    private Integer readFlag;//阅读状态1已阅读
    private Integer delStatus;//-1已删除
    private Integer receiveType;//企业获得简历的来源 （0=个人主动应聘，1=后台推荐，2=企业主动邀请，3=视频面试） 参见:Constants.COM_CATCH_RESUME_FROM_PERSON
    ...
    private transient Integer resumeType;  //简历类型:0：普通简历 1: 为长沙类型的简历 2: 名片,参见：CommonEnum.ResumeType
