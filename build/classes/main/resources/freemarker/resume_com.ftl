...
<#if (perUserVo.userName)?exists && perUserVo.userName !="">
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
	  	<tr>
                          ...
                          <td>
                              ...
                              <span id="mobile_${id}">
                                  <#if loginFlag && buyFlag >
                                      ...
                                      <span data-act="attr" data-id="${id}" data-tel="${perUserVo.mobile}">${(perUserVo.mobilePlace)!}</span>
                                  <#else>
                                     <span id="tel"><a class="button" href="#"  data-act="buy" data-id="${id}" ><@tobuy/></a></span><span id="attr" data-id="" data-tel=""></span>
                                  </#if>
			...
			<#else>
			    <img id="avatar_${id}" src="${imageUrl}/static/img/photoScreen.gif" width="120" height="160"/>
			</#if>
	...
	<#list workInfoVoList as workInfoVo>
		<tr>
		  	<td style="<#if workInfoVo_index != 0>border-top:solid 1px #ddd;</#if>padding-top:5px;"><strong>
			  	...
			  	<span id="comName_${id}${workInfoVo_index}">
...
<div class="itemBlock" id="certificate_${id}"<#if !buyFlag> style="display:none"</#if>>
	<#if loginFlag && buyFlag >
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
	    <tr>
	      	<td class="titBar" style="padding:5px 20px;border-top:1px solid #666666;background:#efefef;">
...
<div class="itemBlock" id="accessory_${id}"<#if !buyFlag> style="display:none"</#if>>
<#if loginFlag && buyFlag >
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
	    <tr>
	      	<td class="titBar" style="padding:5px 20px;border-top:1px solid #666666;background:#efefef;">
...
<#if (perUserVo.userName)?exists && perUserVo.userName !="">
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
	  	...
	  	<tr>
	    	<td id ="contact_${id}">
	    		<#if !buyFlag >
				    <a class="button" href="#"  data-act="buy" data-id="${id}" ><@tobuy/></a>
				</#if>
	    		<#if loginFlag && buyFlag >
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
			  		<tr>
						...
						<td width="350">
							...
							<span style="float:left" data-act="attr" data-id="${id}" data-tel="${perUserVo.mobile}">${(perUserVo.mobilePlace)!}</span>
