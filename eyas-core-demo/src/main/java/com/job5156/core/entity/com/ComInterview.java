...
@DynamicInsert
@SelectBeforeUpdate
public class ComInterview implements Serializable {
    ...
    private Date startDate;     // 面试开始时间
    private Date endDate;       // 面试结束时间
    private String inviteDetail;     // 邀请详情
    ...
    private String contactPerson;    // 面试联系人
