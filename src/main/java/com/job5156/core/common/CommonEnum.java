...
//                Constants.POS_STATUS_DELETED //所有职位中不包括回收站中的
    ...
    *
    ...
    public enum ComeFrom {
    	...
    	SCHOOL_DG_LIGONG_LQY(2001, "校园大使-东莞理工-李秋宜"),
    	SCHOOL_DG_LIGONG_YX(2002, "校园大使-东莞理工-杨轩"),
        SCHOOL_ZS_XINHUA_ZJH(2003, "校园大使-中山新华-朱俊濠"),
        SCHOOL_XSD_YB(2004, "校园大使-西石大-杨斌"),
        SCHOOL_XA_WAIYUAN_HZY(2005, "校园大使-西安外院-胡卓艺"),
        SCHOOL_GG_HZ(2006, "校园大使-广工-宏治"),
        SCHOOL_SJZYZ_ZS(2007, "校园大使-石家庄医职-周森"),
        SCHOOL_GK_LZH(2008, "校园大使-广科-梁振洪"),
        SCHOOL_USE(2009, "校园大使-使用"),

    	WEIXIN_INTOCOMEASY_REG(3000, "进厂易注册"),
		WEIXIN_HOUSEKEEPING_REG(3001,"家政注册"),
		WEIXIN_MEIHAN_REG(3002, "美翰注册"),

    	CRM_PER_REG(4000, "crm用户注册");
