...
public class Constants {
    ...
    public static final int INTOEASY_PAGE_SIZE = 5; //进厂易的分页数
    ...
    public static final String SYS_POSITION_AUDIT_NOT_PASS = "sys:position:audit:not:pass";//后台职位审核不通过
    /**
    ...
    public static final String COOKIE_DOMAIN_JSRC = ".jsrc.com";//江苏人才网的cookie domain
	// ========== Cookie Key ========== End
    ...
    public static final String REDIS_KEY_POS_DAILY_VIEW_COUNT = "pos:daily:view:count"; //网络职位当天被查看次数map
    ...
    public static final String REDIS_KEY_JINJIANG_POS_LIST = "jinjiang:pos:list:";		// 晋江专场职位列表前缀 + (类别)
    ...
    public static final String REDIS_KEY_DYNAMIC_RANDOMCODE = "dynamic:random:code";//动态码(10位随机码)
    ...
    /* 正在执行发货处理(兑现)的订单Map<String,Date>(key:订单id,value:开始执行处理的时间点) */
    public static final String REDIS_KEY_SENDING_OUT_GOODS_COM_ORDERS = "redis:key:sending:out:goods:com:orders";

    /* <pre>智聘企业端订单 - 按订单状态分类统计结果缓存。Map<String,Map<Integer,Integer>></pre>
     * 按企业用户id索引对应统计结果map
     * 该map的键为订单状态码，参见ComServiceOrder.OrderStatus
     * 该map的值为统计数
     */
    public static final String REDIS_KEY_COM_ORDERS_COUNT_MAP = "redis:key:com:orders:count:map";
    //企业发票申请在线支付快递费后 - 标识正在执行后续交易更新的各个发票申请记录。redis map存储，key(String)是记录id, value（Date)是开始执行的时间点
    public static final String REDIS_KEY_FINISHING_COM_RECEIPT_APPLY_FEE_PAY = "redis:key:finishing:com:receipt:apply:fee:pay";

    /*防止企业增值服务订单重提交。SET<String>*/
    public static final String REDIS_KEY_COM_ORDER_AVOID_RE_SUBMIT = "redis:key:com:order:avoid:re:submit";

    /**
     * 集团官网，咨询反馈，发送邮件验证
     */
    public static final String REDSI_KEY_PROJ_OFFICIAL_MAIL_VALIDATION ="proj:official:mail:validation:";
    public static final String REDIS_KEY_POS_DETAIL_ARTICLE_PREFIX = "pos:article:consultation:";	// 职位详细页面文章资讯列表
    ...
    public static final String REDIS_KEY_EJB_REQUEST_COUNT_PREFIX = "ejb:request:count:";   //EJB服务请求次数前缀

    /**
     * 校校招城市开通redis的KeyL
     */
    public static final String REDIS_KEY_PROJ_PARTTIME_DREDGE = "proj:parttime:dredge"; //校校招城市开通
    // ========== Redis Key ========== End
    ...
    //==============  ==================
    /** 业登录后未读消息数量 */
    public static final String REDIS_KEY_COM_MSG_RES_COUNT_PREFIX = "com:msg:res:count:";
    /** 智聘企业首页和简历库的消息及各种简历总数据缓存key */
    public static final String COM_MSG_RES_COUNT_TIPS = ":count_tips";
    /** 收到简历未读 */
    public static final String COM_NEW_MSG_RECEIVE ="msg_rev";
    /** 审核不通过职位未处理记 */
    public static final String COM_NEW_MSG_POS ="msg_pos";
    /** 未读咨询记录R&Q */
    public static final String COM_NEW_MSG_RQ ="msg_rq";
    /** 收到预约未读记录 */
    public static final String COM_NEW_MSG_IRC ="msg_irc";
    /** 职位投递率 */
    public static final String COM_NEW_MSG_POS_AVG ="msg_avg";
    /** 收到简历未读总数 */
    public static final String COM_ZP_COUNT_RECEIVE_NEW = "res_receive_new";
    /** 收到简历总数 */
    public static final String COM_ZP_COUNT_RECEIVE_ALL = "res_receive_all";
    /** 系统推荐未读总数*/
    ...
    /** 已购买总数   */
    public static final String COM_ZP_COUNT_BUY = "res_store_buy";
    /** 收藏总数    */
    public static final String COM_ZP_COUNT_FAVORITE = "res_store_favorite";
    /** 名片未读总数  */
    public static final String COM_ZP_COUNT_CARD_NEW = "res_card_new";
    /** 名片总数    */
    public static final String COM_ZP_COUNT_CARD_ALL = "res_card_all";
    /** 简历处理数  */
    public static final String COM_ZP_RESUME_TREATMENT = "res_treatment";
    /** 微名片处理数   */
    public static final String COM_ZP_CARD_TREATMENT = "res_card_treatment";
    /** 过期时间8小时 */
    public static final long COM_ZP_COUNT_EXPRIY_8HR = 3600*8l;
    ...
    // ========== 企业营业执照审核状态  ========== StartComBusinessLicenseDao
    public static final int COM_BUSINESS_LICENCE_WAIT = 0;  //待审核：用户非工作时间发布的职位，通过审核后变成状态1
    public static final int COM_BUSINESS_LICENCE_PASS = 1;  //审核通过·：用户非工作时间发布的职位，通过审核后变成状态-1
    public static final int COM_BUSINESS_LICENCE_STOP = -1; //审核不通过：用户非工作时间发布的职位，通过审核后变成状态0
    public static final int COM_BUSINESS_LICENCE_PASS_FLAG = 1;//审核曾经通过的标志
    // ========== 企业营业执照审核状态  ========== End
...
// ========== 企业发送信息(模板）类别  ========== Start
     ...
     * cms系统域名
     */
    public static final String CMS_SYS_DOMAIN_NAME = "http://article.job5156.com";

    /**
     * 智通通行证密码修改
     */
    public static final String CHITONE_PASS_MODIFY_PASS_UPDATE_POST = "http://weixin.hr5156.com/Chitone-Account-modifyAinfoPwd";

      /*制造业活动和求职风暴活动编码*/

   public static final Integer SPECIAL_FIELD_TYPE_MANUFACTURE=0;
   public static final Integer SPECIAL_FILED_TYPE_STORM=1;

    /** 邮件中图片URL业务类型 */
    public  static  final   String EMAIL_IMG_RESUME_TRANSMIT ="transmit";//企业收到的简历-转发
    public  static  final   String EMAIL_IMG_APPLY_JOB ="apply";//个人应聘

    /**
     * 转换到智聘对应的薪资数据
     */
    public static Map<Integer ,Integer[]> TO_ZP_SALARY_MAP =new HashMap<>();
    static  {
        TO_ZP_SALARY_MAP.put(-1, new Integer[]{0, 0}); //老数据存在这种情况
        TO_ZP_SALARY_MAP.put(0, new Integer[]{0, 0});
        TO_ZP_SALARY_MAP.put(1, new Integer[]{0, 1499});
        TO_ZP_SALARY_MAP.put(2, new Integer[]{1500, 1999});
        TO_ZP_SALARY_MAP.put(3, new Integer[]{2000, 2999});
        TO_ZP_SALARY_MAP.put(4, new Integer[]{3000, 4499});
        TO_ZP_SALARY_MAP.put(5, new Integer[]{4500, 5999});
        TO_ZP_SALARY_MAP.put(6, new Integer[]{6000, 7999});
        TO_ZP_SALARY_MAP.put(7, new Integer[]{8000, 9999});
        TO_ZP_SALARY_MAP.put(8, new Integer[]{10000, 14999});
        TO_ZP_SALARY_MAP.put(9, new Integer[]{15000, 19999});
        TO_ZP_SALARY_MAP.put(10, new Integer[]{20000, 29999});
        TO_ZP_SALARY_MAP.put(11, new Integer[]{30000, 49999});
        TO_ZP_SALARY_MAP.put(12, new Integer[]{50000, 100000});
    }
