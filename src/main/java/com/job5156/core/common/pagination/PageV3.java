...
public class PageV3<T> {
	...
	public PageV3<T> pageNo(final int thePageNo) {
		setPageNo(thePageNo);
		return this;
	}
	...
	public PageV3<T> pageSize(final int thePageSize) {
	...
	public PageV3<T> orderBy(final String theOrderBy) {
	...
	public PageV3<T> order(final String theOrder) {
		setOrder(theOrder);
		return this;
	}
	...
	public PageV3<T> autoCount(final boolean theAutoCount) {
