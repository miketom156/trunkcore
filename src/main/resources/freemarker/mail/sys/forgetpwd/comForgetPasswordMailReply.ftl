...
<table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
        <td style="padding:8px">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td width="273"><a href="${siteUrl}" target="_blank"><img
                            src="${imageUrl}/static/style/mail/perAccount/logo.png" width="273" height="45" alt="智通人才网"
                            border=0/></a></td>
                    <td align="right" style="font-size:12px;line-height:21px;color:#8c8b8b">此邮件来自<a
                            href="http://www.job5156.com/" target="_blank"
    ...
    <tr>
        <td background="${imageUrl}/static/style/mail/perAccount/di_2.png"
            style="border-top: 3px solid #0076c7;padding:17px; font-size:12px;">
        ${replyContent}
    ...
    <tr>
        <td height="100" style="font-size:12px; padding:5px 17px 5px 17px; color:#888;" bgcolor="#f0f0f0">
            ...
            <p align="left" style="text-indent:2em;">
                智通人才网（www.job5156.com）1999年9月始创于中国东莞市，由中国最大的人才服务连锁品牌——广东智通人才连锁集团全资创办和运营，是智通人才连锁旗下支柱产品之一。智通人才网在全国首倡“线上+线下”的互动招聘服务模式，有效保证人才求职和企业招聘的效果。随着公司在全国的连锁运营，智通人才网已在全国二十多个大中型城市开设了分站，积极推进网站的本地化运营。智通人才网始依托资深人力资源服务经验，及时洞察市场供求的微观变化，并开发针对性地功能与信息服务，服务效果始终有保障。</p>
        </td>
    </tr>
    <!--footer begin-->
    <tr>
